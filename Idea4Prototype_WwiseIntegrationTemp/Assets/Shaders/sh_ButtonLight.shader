...
////// Specular:
                ...
                float3 diffuseColor = lerp(_Toggle_On_var,(_Toggle_On_var*_Shadow_Modifier.rgb),step(dot(lightDirection,i.normalDir),_Shadow_Cutoff)); // Need this for specular when using metallic
